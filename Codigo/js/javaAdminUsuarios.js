...
const validarFormularioRegistroAdminUsuario = (e) => {
	switch (e.target.name) {
		...
		break;
		case "fN":
			validarCampoRegistroAdminUsuario(expresionesRegistroAdminUsuario.nacimiento, e.target, 'fN');
		break;
		case "dni":
...
registroAdminUsuario.addEventListener('submit', (e) => {
	...
	if(camposRegistroAdminUsuario.usuario && camposRegistroAdminUsuario.password && camposRegistroAdminUsuario.nombre && camposRegistroAdminUsuario.apellido1 && camposRegistroAdminUsuario.apellido2 && camposRegistroAdminUsuario.nacimiento && camposRegistroAdminUsuario.dni && camposRegistroAdminUsuario.telefono && camposRegistroAdminUsuario.correo && camposRegistroAdminUsuario.cp && camposRegistroAdminUsuario.direccion && camposRegistroAdminUsuario.rol){
