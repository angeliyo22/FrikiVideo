...
const validarFormularioRegistro = (e) => {
	switch (e.target.name) {
		...
		break;
		case "fN":
			validarCampoRegistro(expresionesRegistro.fN, e.target, 'fN');
		break;
		case "dni":
...
registro.addEventListener('submit', (e) => {
	...
	if(camposRegistro.usuario && camposRegistro.password && camposRegistro.nombre && camposRegistro.apellido1 && camposRegistro.apellido2 && camposRegistro.fN && camposRegistro.dni && camposRegistro.telefono && camposRegistro.correo && camposRegistro.cp && camposRegistro.direccion){

		document.querySelector(`#registro .mensaje_exito_boton`).classList.add('grupo_correcto');
		document.querySelector(`#registro .mensaje_exito_boton`).classList.add('mensaje_error_visible');
		setTimeout(() => {
