          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th id="centrado">PrecioTotal</th>
                <th id="centrado">Fecha</th>
                <th id="centrado">Estado</th>
              </tr>
            </thead>
            <tbody>
              <?php 
                ...
                $consulta=consultaPedidos($conexion);
              ...
              <tr>
                ...
                <td id="centrado" style="width:180px;"><?php echo $mostrar['PrecioTotal'];?></td>
                <td id="centrado" style="width:180px;"><?php echo $mostrar['Fecha'];?></td>
                <td id="centrado" style="width:180px;"><?php echo $mostrar['Estado'];?></td>
                <td id="centrado" style="width:180px;">
                  <a href="detallesPedidos.php?id=<?php echo $mostrar['idPedidos'] ?>" class="btn btn-success"><i class="fas fa-search-plus"></i></a>
                </td>
              </tr>
              <?php
                }
