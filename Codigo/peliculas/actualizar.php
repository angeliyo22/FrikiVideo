...
$resultado=mostrarPeliId($conexion,$id);
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <input type="hidden" name="id" value="<?php echo $fila['idPeliculas'] ?>">
                        <div class="row">
                            <div class="col-md-8">
                                <!-- Titulo -->
                                <div class="form-group" id="grupo_titulo">
                                    <label for="titulo" class="label">Titulo</label><br>
                                    <input class="form-control" type="text" name="titulo" value="<?php echo $fila['Titulo'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group" id="grupo_productora">
                                    ...
                                    <input class="form-control" type="text" name="productora" value="<?php echo $fila['Productora'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group" id="grupo_publicacion">
                                    ...
                                    <input class="form-control" type="text" name="publicacion" value="<?php echo $fila['Publicacion'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group" id="grupo_stock">
                                    ...
                                    <input class="form-control" type="text" name="stock" value="<?php echo $fila['Stock'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group" id="grupo_precio">
                                    ...
                                    <input class="form-control" type="text" name="precio" value="<?php echo $fila['Precio'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <br>
